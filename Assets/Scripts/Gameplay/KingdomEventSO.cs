...
[CreateAssetMenu(menuName = "Kingdom Event Data")]

public class KingdomEventSO : ScriptableObject
{
    [field: SerializeField] public string EventName { get; private set; }
    [field: SerializeField, TextArea(5, 5)] public string EventDescription { get; private set; }
    ...
    public string GetEventResultTextInfo()
    {
        string info = "";
